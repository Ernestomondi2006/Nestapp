    ...
    Column (modifier = Modifier.fillMaxSize()){
        ...
        TopAppBar(
            ...
            colors = TopAppBarDefaults.topAppBarColors(
                navigationIconContentColor = newbwhite,
                containerColor = newblue,
                titleContentColor = newbwhite,
                actionIconContentColor = newbwhite
        ...
        Button(onClick = {
            ...
            callIntent.data="tel:0117097206".toUri()
     ...
     //End ot call
        ...
        Button(onClick = {
            ...
            val shareIntent = Intent(Intent.ACTION_SEND)
            shareIntent.type = "text/plain"
            shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("ernestomondi2006@gmail.com"))
